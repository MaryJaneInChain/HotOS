...
void putfont8_asc(unsigned char *vram,int xsize,int x,int y,char color,unsigned char *string);
void putfont8_asc_shadow(unsigned char *vram,int xsize,int x,int y,char color,unsigned char *string);
